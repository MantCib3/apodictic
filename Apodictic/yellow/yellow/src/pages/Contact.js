...
const Contact = () => (
  <div className="section-view">
    ...
    <div className="article-detail">
      <p>Welcome to Apodictic, your trusted source for reliable and timely news coverage since 2025. Our mission is to deliver accurate, insightful, and engaging content that keeps you informed about the world around you.</p>
